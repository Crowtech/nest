...
class Device {
  ...
  _registerDevice() async {
    ...
    String url = ProjectEnv.devicesUrl;
    String json =
        '{"code":"$deviceCode", "type": "$deviceType" , "version":"$deviceVersion" }';
    // make POST request
    print("Registering Device $json");
    var statusCode = await postHTTP(url, json);
